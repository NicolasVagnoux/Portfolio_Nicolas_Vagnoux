export const projects = [
  {
    id: "star-tour",
    name: "Star Tour",
    logo: "/assets/projects/startour-logo.svg",
    img: "/assets/projects/startour.jpg",
    shortDesc:
      "Projet d'études : Création du site web d'une agence de voyage fictive",
    longDesc:
      "Projet d'études réalisé en 5 semaines au sein d'une équipe de 5 étudiants. L'objectif était de créer le site web d'une agence de voyages fictive basée sur l'univers de la saga Star Wars.",
    technologies: [
      {
        name: "Html/Css/Js",
  ...
  },
  {
    ...
    shortDesc:
      "Projet d'études : création d'une plateforme d'apprentissage en ligne sur le thème de la Blockchain",
    longDesc:
