  ...
  return (
    <div className="skills" id="skills">
      ...
      <p className="skills__intro">
        ...
        j&apos;ai eu l&apos;occasion d&apos;apprendre à maitriser de nombreuses
        technologies, à la fois du côté <span>Front-End</span> (conception de
        sites et d&apos;expériences utilisateur) et du côté{" "}
        <span>Back-End</span> (création et gestion de bases de données et API).
        <br />
        <br />
        Etant quelqu&apos;un de rigoureux, adaptable, proactif, et utilisant les{" "}
        <span>prinicpaux outils de travail</span> du développeur
